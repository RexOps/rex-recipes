...
A DataNode stores data in the Hadoop-File-System. A functional filesystem
...
This task will stop the Hadoop DataNode service.
   ...
   task yourtask => sub {
      Rex::Framework::Cloudera::Hadoop::DataNode::stop();
   };
...
This task will restart the Hadoop DataNode service.
   ...
   task yourtask => sub {
      Rex::Framework::Cloudera::Hadoop::DataNode::restart();
   };
